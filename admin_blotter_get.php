...
echo json_encode([
  ...
  "incident" => [
    "id" => (int)$row["id"],
    "reporter_user_id" => $row["reporter_user_id"] !== null ? (int)$row["reporter_user_id"] : "",
  ...
  "persons" => array_map(function($r) {
    return [
      ...
      "age" => isset($r["age"]) && $r["age"] !== null ? (int)$r["age"] : "",
      ...
      "suspect_status" => $r["suspect_status"] ?? "UNKNOWN",
      ...
      "is_afp_pnp_personnel" => (int)($r["is_afp_pnp_personnel"] ?? 0),
      "rank_title" => $r["rank_title"] ?? "",
      "unit_assignment" => $r["unit_assignment"] ?? "",
      "group_affiliation" => $r["group_affiliation"] ?? "",
      "has_previous_criminal_record" => (int)($r["has_previous_criminal_record"] ?? 0),
      "previous_case_status" => $r["previous_case_status"] ?? "",
      "height_cm" => isset($r["height_cm"]) && $r["height_cm"] !== null ? (float)$r["height_cm"] : "",
      "weight_kg" => isset($r["weight_kg"]) && $r["weight_kg"] !== null ? (float)$r["weight_kg"] : "",
      "built" => $r["built"] ?? "",
